...
@section('bread-small') Assign Permissions  @stop
@section('breadcrumb')
    <li class="active">
                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="checkbox icheck">
                                    <label>
                                        <input type="checkbox" name="accountant">&nbsp;&nbsp;&nbsp;&nbsp; Allowed to view Financial pages ,
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="checkbox icheck">
                                    <label>
                                        <input type="checkbox" name="admin">&nbsp;&nbsp;&nbsp;&nbsp; Allowed to do everything except Roles and
                                        permissions .
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="checkbox icheck">
                                    <label>
                                        <input type="checkbox" name="superadmin">&nbsp;&nbsp;&nbsp;&nbsp; Can do everything in every where .
                                    </label>
                                </div>
                            </td>
                        </tr>
